...
<template>
    ...
    <!-- <form id="form" @submit.prevent="onSubmit">
      <div class="form-control">
        ...
        <input type="text" id="title" placeholder="Enter title..." v-model.laxy.trim="newNote.title" />
      </div>
      <div class="form-control">
        <label for="content">{{ props.content }}</label
        >
        <input
          type="text"
          id="content"
          placeholder="Enter content..."
          v-model.laxy.trim="newNote.content"
        />
      </div>
